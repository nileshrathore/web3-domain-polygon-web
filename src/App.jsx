...
const tld = '.butter';
const CONTRACT_ADDRESS = '0x63545bead72A6F902F9EE559fb2b4B09D93422dA';
...
const editRecord = (name) => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/x84Vdy91Q4O88/giphy.gif" alt="Ninja gif" />
...
const renderMints = () => {
  ...
  return (
	...
	<header>
		<div className="left">
			<p className="title">🧈 Butter Name Service</p>
